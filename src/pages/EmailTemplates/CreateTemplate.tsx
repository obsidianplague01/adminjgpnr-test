...
export default function CreateTemplate() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Created template:", formData);
  ...
  return (
    <>
      <PageMeta title="Create Email Template | JGPNR Admin Panel" description="Create new email template" />
      <PageBreadcrumb pageTitle="Create Email Template" />

      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="lg:col-span-2">
          <ComponentCard title="Template Details" desc="Configure your email template">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <li className="flex items-start gap-2">
                <span className="text-brand-500">•</span>
                <span>Test templates before setting them active</span>
              </li>
            </ul>
          </div>
        </div>
